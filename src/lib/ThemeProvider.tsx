...
const setStoredTheme = createIsomorphicFn().client((theme: UserTheme) => {
...
const handleThemeChange = createIsomorphicFn().client((userTheme: UserTheme) => {
...
const setupPreferredListener = createIsomorphicFn().client(() => {
