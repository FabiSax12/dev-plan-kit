...
import { Route } from "@/routes/_app/ai-assistant"

const navItems = [
    { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
    { href: "/projects", label: "Projects", icon: FolderKanban },
    { href: "/ideas", label: "Ideas", icon: Lightbulb },
    { href: "/ai-assistant", label: "AI Assistant", icon: Sparkles, isCollapsible: true },
]
...
export function AIChatSidebar({ conversations }: AIChatSidebarProps) {
